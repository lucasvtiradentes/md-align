...
Module: `src/docalign/checks/box_walls.py`
...
related sources:
- src/docalign/checks/box_walls.py - check and fix implementation
- src/docalign/utils.py            - BOX_WALL_DRIFT, _find_box_closer, _find_nearby_wall, _shift_wall, _fix_closer
